// Investor billing — reuses BillingClient
import { redirect } from "next/navigation";
import { createClient } from "@/lib/supabase/server";
import { BillingClient } from "../../founder/billing/client";
import { INVESTOR_NAV } from "../client";

export default async function InvestorBillingPage() {
  ...
  return <BillingClient profile={profile} subscription={sub} invoices={invoices??[]} role="investor" navItems={INVESTOR_NAV}/>;
}
